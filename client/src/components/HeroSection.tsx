export default function HeroSection() {
  return (
    <div className="relative min-h-screen text-black bg-white">
      {/* Left accent line */}
      <div className="absolute left-0 top-0 h-[90%] w-0.5 bg-gradient-to-b from-[#40E0D0] via-[#00ff88] to-[#90EE90] pt-[0px] pb-[0px] pl-[4px] pr-[4px] ml-[15px] mr-[15px] mt-[20px] mb-[20px]"></div>
      {/* Main content */}
