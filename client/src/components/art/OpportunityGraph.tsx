export function OpportunityGraph() {
  return (
    <svg width="600" height="300" viewBox="0 0 600 300" className="mx-auto">
      ...
      <g opacity="0.4">
        {/* Policy column */}
        <rect x="40" y="60" width="120" height="180" rx="12" fill="none" stroke="hsl(var(--muted-foreground))" strokeWidth="1.5" strokeDasharray="4,4" />
        <text x="100" y="45" textAnchor="middle" fill="hsl(var(--muted-foreground))" fontSize="14">Policy</text>
        
        {/* Capital column */}
        <rect x="240" y="60" width="120" height="180" rx="12" fill="none" stroke="hsl(var(--muted-foreground))" strokeWidth="1.5" strokeDasharray="4,4" />
        <text x="300" y="45" textAnchor="middle" fill="hsl(var(--muted-foreground))" fontSize="14">Capital</text>
        
        {/* Operations column */}
        <rect x="440" y="60" width="120" height="180" rx="12" fill="none" stroke="hsl(var(--muted-foreground))" strokeWidth="1.5" strokeDasharray="4,4" />
        <text x="500" y="45" textAnchor="middle" fill="hsl(var(--muted-foreground))" fontSize="14">Operations</text>
      </g>
      ...
      {/* Connecting lines */}
      <g opacity="0.3" stroke="hsl(var(--muted-foreground))" strokeWidth="1.5" fill="none">
