    ...
    return (
      <div className="group cursor-pointer" data-testid={`card-article-hero-${article.id}`}>
        <LinkWrapper>
          ...
          {article.source && (
            <p className="verge-meta-text text-[#f2007d] mb-4 font-medium" data-testid={`text-source-hero-${article.id}`}>
              {article.source}
            </p>
          )}
        ...
        <LinkWrapper>
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {article.source && (
                <p className="verge-meta-text text-[#f2007d] mb-2 font-medium" data-testid={`text-source-featured-${article.id}`}>
                  {article.source}
                </p>
              )}
        ...
        <LinkWrapper>
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {article.source && (
                <p className="verge-meta-text text-[#f2007d] mb-2 font-medium text-sm" data-testid={`text-source-list-${article.id}`}>
                  {article.source}
                </p>
              )}
  ...
  return (
    <div className="group cursor-pointer" data-testid={`card-article-standard-${article.id}`}>
      <LinkWrapper>
        ...
        {article.source && (
          <p className="verge-meta-text text-[#f2007d] mb-2 font-medium" data-testid={`text-source-standard-${article.id}`}>
            {article.source}
          </p>
        )}
