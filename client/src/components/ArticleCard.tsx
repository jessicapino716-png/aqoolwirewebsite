    ...
    return (
      <div className="group cursor-pointer" data-testid={`card-article-hero-${article.id}`}>
        <LinkWrapper>
          ...
          {article.source && (
            <p className="verge-meta-text text-[#00e676] mb-4 font-medium" data-testid={`text-source-hero-${article.id}`}>
              {article.source}
            </p>
          )}
        ...
        <LinkWrapper>
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {article.source && (
                <p className="verge-meta-text text-[#00e676] mb-2 font-medium" data-testid={`text-source-featured-${article.id}`}>
                  {article.source}
                </p>
              )}
        ...
        <LinkWrapper>
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {article.source && (
                <p className="verge-meta-text text-[#00e676] mb-2 font-medium text-sm" data-testid={`text-source-list-${article.id}`}>
                  {article.source}
                </p>
              )}
  ...
  return (
    <div className="group cursor-pointer" data-testid={`card-article-standard-${article.id}`}>
      <LinkWrapper>
        ...
        {article.source && (
          <p className="verge-meta-text mb-2 text-[#07e099] font-bold" data-testid={`text-source-standard-${article.id}`}>
            {article.source}
          </p>
        )}
