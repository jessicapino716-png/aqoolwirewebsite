  ...
  return (
    <div style={{ background: "#070d18", minHeight: "100vh", color: "#e2e8f0", fontFamily: "'Inter', sans-serif", position: "relative", overflowX: "hidden" }}>
      ...
      <section style={{ position: "relative", zIndex: 1, maxWidth: "1080px", margin: "0 auto" }}
        ...
        <p style={{ fontSize: "1.15rem", color: "#cbd5e1", lineHeight: 1.72, margin: "0 0 1.75rem 0" }}>The Saudi-specific complication compounds the problem in two layers. First, Vision 2030 is making large bets on labor-intensive sectors (tourism gigaprojects like Red Sea Global, Diriyah, AlUla, and Qiddiya) alongside its capital-intensive bets in AI infrastructure (HUMAIN, PIF's AI investment vehicle). The labor-intensive bets do generate jobs per dollar, but historically those jobs have been filled by expatriate workers under the kafala system, not Saudi nationals. Second, the higher-skill jobs that Saudization policies have been pushing nationals into (finance, professional services, administration) are exactly the jobs AI is automating fastest. The compound risk is that low-skill jobs continue to flow to expats while high-skill jobs get automated before Saudis fully fill them.</p>
