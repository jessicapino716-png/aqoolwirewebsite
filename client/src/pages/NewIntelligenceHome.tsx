    ...
    <div style={{ background: "#070d18", minHeight: "100vh", color: "#e2e8f0", fontFamily: "'Inter', sans-serif", position: "relative", overflowX: "hidden" }}>
      ...
      <section style={{ position: "relative", zIndex: 1, minHeight: "85vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center" }}
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "920px", width: "100%" }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-[50px]" style={{ marginTop: "2rem" }}>
            <Link href="/research"
      ...
      <section style={{ position: "relative", zIndex: 1, maxWidth: "1080px", margin: "-2rem auto 0", background: "rgba(12,24,41,0.72)", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.06)" }}
        className="px-4 md:px-8 pt-8 md:pt-10 pb-16 md:pb-24">
