...
export default function RegulatoryIntelligence() {
  ...
  const categoryArticles = articles?.filter(
    (article) => article.category === "policy" || article.category === "regulation"
  ) || [];

  return (
    <>
      <Helmet>
        <title>Regulatory Intelligence - The Aqool Wire</title>
        <meta
          name="description"
          content="Track the latest AI policy developments, regulatory frameworks, and compliance updates across Saudi Arabia and the GCC region."
        />
      </Helmet>
      ...
      <main className="min-h-screen relative z-10">
        <div className="max-w-7xl mx-auto px-4 py-12 lg:py-16">
          {/* Hero Section */}
          <div className="mb-12">
            <span className="kicker mb-4">Regulatory Intelligence</span>
            ...
            <p className="text-xl text-gray-400 max-w-3xl leading-relaxed">
              Comprehensive tracking of AI policy developments, regulatory frameworks, and compliance requirements across Saudi Arabia and the GCC region.
            </p>
          </div>
